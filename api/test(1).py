...
def init_ip():
    ...
    print(requests.post(url="http://www.hyluz.cn:5000/init_ip",data=data).text)

def get_puk_sq():
    data={
    'ip':ip
    }
    result=requests.post(url="http://www.hyluz.cn:5000/get_puk_sq",data=data)
...
def init_token():
    ...
    result=requests.post(url="http://www.hyluz.cn:5000/init_token",data=data)
...
def check_token():
    ...
    result=requests.post(url="http://www.hyluz.cn:5000/check_token",data=data)
    result=json.loads(result.text)
    print(result)
...
def decrypt():
    ...
    cypher=cipher_text.replace('+','@')
    url="http://www.hyluz.cn:5000/server_decode?ip="+ip+"&sq="+sq+"&cypher="+cypher
    #print(url)
...
def msg_sql():
    ...
    result=requests.post(url="http://www.hyluz.cn:5000/msg_sql",data=data)
    result=json.loads(result.text)
    print(result)
...
def token_sql():
    ...
    result=requests.post(url="http://www.hyluz.cn:5000/token_sql",data=data)
    result=json.loads(result.text)
    print(result)
...
def update_token_consume():
    ...
    result=requests.post(url="http://www.hyluz.cn:5000/update_token_consume",data=data)
    result=json.loads(result.text)
    print(result)
...
def token_consum_search():
    ...
    result=requests.post(url="http://www.hyluz.cn:5000/token_consum_search",data=data)
    result=json.loads(result.text)
    print(result)
...
def update_msg_check_consume():
    ...
    result=requests.post(url="http://www.hyluz.cn:5000/update_msg_check_consume",data=data)
    result=json.loads(result.text)
    print(result)
...
def msg_check_consum_search():
    ...
    result=requests.post(url="http://www.hyluz.cn:5000/msg_check_consum_search",data=data)
    result=json.loads(result.text)
    print(result)
