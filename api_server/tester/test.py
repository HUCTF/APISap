...
def init_ip():
    ...
    print(requests.post(url="http://39.96.60.14:5000/init_ip",data=data).text)
def get_puk_sq():
    data={
    'ip':ip
    }
...
def init_token():
    ...
    result=requests.post(url="http://39.96.60.14:5000/init_token",data=data)
...
def decrypt():
    ...
    result=requests.post(url="http://39.96.60.14:5000/server_decode",data=data)
    result=json.loads(result.text)
    #print(result)
